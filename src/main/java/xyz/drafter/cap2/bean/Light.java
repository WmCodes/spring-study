...
public class Light  implements ApplicationContextAware, BeanNameAware, EmbeddedValueResolverAware {
    // 实现BeanNameAware 与 ApplicationContextAware
    ...
    public void setEmbeddedValueResolver(StringValueResolver resolver) {
        String result = resolver.resolveStringValue("setEmbeddedValueResolver: ${os.name},计算#{3*8}");
